...
<Library LVVersion="16008000">
	...
	<Item Name="GMaps API Help.chm" Type="Document" URL="../GMaps API Help.chm"/>
	<Item Name="GMaps API.aliases" Type="Document" URL="../GMaps API.aliases"/>
	<Item Name="GMaps API.lvlps" Type="Document" URL="../GMaps API.lvlps"/>
	<Item Name="MIT License (NI 2017).txt" Type="Document" URL="../MIT License (NI 2017).txt"/>
</Library>
